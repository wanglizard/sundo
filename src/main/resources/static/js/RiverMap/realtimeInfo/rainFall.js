...
let apiUrl2 = "https://api.hrfco.go.kr/89D58E93-6886-47F5-B9F4-A965F0D3FD60/rainfall/info.json";
...
function fetchAndDisplayData(startD, endD) {
	...
	for (let j = 0; j < rfobscd.length; j++) {
		let apiUrl1 = "https://api.hrfco.go.kr/89D58E93-6886-47F5-B9F4-A965F0D3FD60/rainfall/list/" + searchType + "/" + rfobscd[j] + "/" + startD + "/" + endD + ".json";
		(function(index) {
...
function searchAndFetch(startD, r_codes, r_names, r_roles, endD) {
	...
	for (let j = 0; j < r_codes.length; j++) {
		let apiUrl1 = "https://api.hrfco.go.kr/89D58E93-6886-47F5-B9F4-A965F0D3FD60/rainfall/list/" + searchType + "/" + r_codes[j] + "/" + startD + "/" + endD + ".json";
		(function(index) {
			promises.push(new Promise(function(resolve, reject) {
				$.get(apiUrl1, function(result) {
					var rainFall = [];
